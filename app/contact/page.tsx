        ...
        <div className="grid gap-12 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-8">
              Whether you have a question about our lessons, need help with a coding problem, 
              or want to give us feedback, we are here to help.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">support@pythonlearn.com</p>
            ...
            <div className="mt-8 pt-8 border-t border-border">
              ...
              <div className="flex gap-4">
                <a href="#" className="flex h-10 w-10 items-center justify-center rounded-lg bg-secondary text-muted-foreground hover:bg-primary hover:text-primary-foreground transition-colors">
          ...
          <div className="rounded-xl bg-card p-8 shadow-sm border border-border">
            ...
            {submitted ? (
              <div className="rounded-lg bg-primary/10 p-6 text-center">
                <div className="flex h-12 w-12 mx-auto items-center justify-center rounded-full bg-primary/20 mb-4">
                  <svg className="h-6 w-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
